...
L2 Contract    api/contract/v3/{schemas/*.json, operations.json, CONTRACT.md} (embedded by api/contract) beside the proto + Go request structs + Canonical* limits; GET /v3/status and `deepdata routes` are its runtime projections
