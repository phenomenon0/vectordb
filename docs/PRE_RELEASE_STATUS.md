...
|---|---|---|---|---|
| DUR-01 | pass | a36faa4 | 2026-09-02 | go vet passes with CGO_ENABLED=0 across the RC package list |
| DUR-02 | pass | a36faa4 | 2026-09-02 | storage tests pass: journal, snapshot, durable store, WAL recovery |
| DUR-03 | pass | a36faa4 | 2026-09-02 | go test -short passes for cmd/deepdata and internal packages |
| DUR-04 | pass | a36faa4 | 2026-09-02 | go test -race passes on the RC package list |
| DUR-05 | pass | a36faa4 | 2026-09-02 | focused persistence matrices pass serially (go test -count=1 -p 1 ./internal/collection ./cmd/d… |
...
| REL-03 | pass | a3b4cfb | 2026-09-02 | go.mod and go.sum are tidy (go mod tidy -diff is empty) |
...
| RCV-04 | pass | a36faa4 | 2026-09-02 | generated small-journal tests fail closed on truncated and corrupt records |
...
|---|---|---|---|---|
| CTL-01 | pass | a36faa4 | 2026-09-02 | errors are prompts: every API error carries code, hint and docs pointer via internal/apierror |
| CTL-02 | pass | a36faa4 | 2026-09-02 | text in, text out: server-side embeddings, Ollama first, hash embedder only when named explicit… |
...
| CTL-05 | pass | a36faa4 | 2026-09-02 | durable usage records survive restart |
...
|---|---|---|---|---|
| MED-01 | pass | a36faa4 | 2026-09-02 | ephemeral collection class: documents write no journal record, the collection is empty after re… |
