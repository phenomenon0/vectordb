...
Readiness: 25 release gates, 10 pass and fresh, 9 pass (stale), 6 not passed. A stale pass counts as open for release.
...
| DUR-05 | pass (stale) | 1726127 | 2026-09-03 | focused persistence matrices pass serially (go test -count=1 -p 1 ./internal/collection ./cmd/d… |
...
| RCV-03 | pass (stale) | a36faa4 | 2026-09-02 | unified snapshots load with bounded memory |
| RCV-04 | pass (stale) | 1726127 | 2026-09-03 | generated small-journal tests fail closed on truncated and corrupt records |
| RCV-05 | open | — | — | replay rehearsal passes under a cgroup memory hard cap on the disposable probe root only |
| RCV-06 | pass (stale) | a36faa4 | 2026-09-02 | internal/index/segmented.go measured under the cold-start memory envelope |
...
| SYS-04 | pass (stale) | 1726127 | 2026-09-03 | Canonical prefix dropped; every live package has a doc.go |
...
|---|---|---|---|---|
| MED-01 | pass (stale) | 1726127 | 2026-09-03 | ephemeral collection class: documents write no journal record, the collection is empty after re… |
