...
Readiness: 25 release gates, 13 pass and fresh, 7 pass (stale), 5 not passed. A stale pass counts as open for release.
...
| DUR-05 | pass | 0a21183 | 2026-09-03 | focused persistence matrices pass serially (go test -count=1 -p 1 ./internal/collection ./cmd/d… |
...
|---|---|---|---|---|
| SOAK-01 | pass | b91479d | 2026-09-03 | sustained soak holds recall, restart-under-load and memory growth within envelope |
...
| RCV-03 | pass | 0a21183 | 2026-09-03 | unified snapshots load with bounded memory |
| RCV-04 | pass | 0a21183 | 2026-09-03 | generated small-journal tests fail closed on truncated and corrupt records |
...
| SYS-03 | pass | 0a21183 | 2026-09-03 | archive tag archive/pre-narrowing-v2 exists; retired packages deleted; go.mod loses cowrie, sha… |
| SYS-04 | pass | 0a21183 | 2026-09-03 | Canonical prefix dropped; every live package has a doc.go |
...
|---|---|---|---|---|
| MED-01 | pass | 0a21183 | 2026-09-03 | ephemeral collection class: documents write no journal record, the collection is empty after re… |
