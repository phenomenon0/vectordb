...
Platform: DOC-02 → DOC-01 → CTL-01 → CTL-02 → CTL-03 → CTL-04 → CTL-05 → SYS-01 → SYS-02 → SYS-03 → SYS-04;
...
- [tasks/gates.json](gates.json) — the ledger: 52 gates, each with statement, command, scope, release_gate, status, evidence, note; scripts/gates.py check validates it, gates.py promote binds a receipt.
