...
> Archived 2026-09-01 from `tasks/autonomy/BASELINE.md`; unedited below this note.
> The toolchain has since moved to go1.25.12 (`go.mod`) — versions below are the 2026-07-17 baseline only.
